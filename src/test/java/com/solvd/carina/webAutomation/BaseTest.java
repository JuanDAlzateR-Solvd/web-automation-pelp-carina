...
public class BaseTest extends AbstractTest {//implements IAbstractTest
    ...
    public AboutUsModal openAboutUsModal() {
        return navigation.openAboutUsModal();
    }

    public SignUpModal openSignUpModal() {
        return navigation.openSignUpModal();
    }
    public ContactModal openContactModal() {
        return navigation.openContactModal();
    }
    public LogInModal openLogInModal() {
        return navigation.openLogInModal();
    }

    public CartPage goToCartPage() {
        return navigation.goToCartPage();
    }

    public HomePage goToHomePage() {
        return navigation.goToHomePage();
    }
